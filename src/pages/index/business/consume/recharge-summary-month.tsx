...
import { getRechargeSummaryMonthList } from '@/api/summaryList';
...
export default () => {
  ...
  const handleRequest = async (params: ParamsType) => {
    ...
    try {
      const result = await getRechargeSummaryMonthList(params1);
